...
#include "diffdemo1_strip.h"
#define GRAPHNAME "diffdemo1"
...
int main(int argc, char *argv[]) {
    ...
    diffdemo1_userdata_t userdata = {.ref_width = ref_width, .ref_height = ref_height};
    ...
    bool create_status = diffdemo1_create(context, graph_skeleton, input_images, output_images, &userdata);
