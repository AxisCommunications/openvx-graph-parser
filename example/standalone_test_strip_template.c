...
/**
 *  @file   standalone_test_strip_template.c
 *  @brief  Template standalone test code for generated graph code.
 *          Use with generated graph files after updating all 'FIXME's in this file.
 */
...
//FIXME: Include the correct generated header and name of graph
#include "XXX_strip.h"
#define GRAPHNAME "XXX"
...
int main(int argc, char *argv[]) {
    ...
    //FIXME: Correct number of inputs and outputs
    int num_inputs = 1;
    int num_outputs = 1;
    ...
    //FIXME: Update potential userdata type name and set the necessary fields specified in the graphml file
    XXX_userdata_t userdata = {.ref_width = ref_width, .ref_height = ref_height};

    //FIXME: Create the correct number of output images and set image dimensions corresponding to graphml file
    ...
    //FIXME: Update the name of the generated create function
    bool create_status = XXX_create(context, graph_skeleton, input_images, output_images, &userdata);
